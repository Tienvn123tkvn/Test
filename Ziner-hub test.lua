...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Welcome Ziner-hub!<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thanks for using<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>script by KAI WIBU<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Dev: Ziner-hub<Color=/>"):Display()
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Maris Hub", HidePremium = false, IntroText = "Maris Hub", SaveConfig = true, ConfigFolder = "Maris Hub"})
...
W:AddLabel("Script By Maris")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Welcome to Ziner-hub!")
W:AddLabel("[+] Discord: https://discord.com/invite/S4EtaxnZ3D")
W:AddLabel("[+] Cày Thuê Ở Discord")
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddLabel("Tự động đánh hình nộm")
