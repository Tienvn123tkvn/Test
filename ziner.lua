...
NotificationLibrary:SendNotification("Warning", "cảm ơn vì dùng script hehe :)", 10)
NotificationLibrary:SendNotification("Warning", "Nhìn cái lồn má mày lo cày lv đi cu", 10)
...
ImageButton.Image = "rbxassetid://71441467882202"
...
local Window = Fluent:CreateWindow({
    Title = "Ziner Hub | Blox Fruits",
    SubTitle = " Make by kaibeo",
    TabWidth = 100,
...
local Tabs = {
    In = Window:AddTab({ Title = "Infor", Icon = "bell-ring"}),
    Sh = Window:AddTab({ Title = "Shop", Icon = "shopping_carl" }),
    Main = Window:AddTab({ Title = "Main", Icon = "home" }),
    Qs = Window:AddTab({ Title = "Other Farm", Icon = "bookmark" }), 
    stack = Window:AddTab({ Title = "Item", Icon = "key-round" }), 
    Se = Window:AddTab({ Title = "Event sea", Icon = "globe" }),   
    St = Window:AddTab({ Title = "Zone", Icon = "cloud-moon" }),    
    Lc = Window:AddTab({ Title = "TP", Icon = "folder" }),   
    spl = Window:AddTab({ Title = "Status", Icon = "arrow-down-up" }),   
    RC = Window:AddTab({ Title = "Race v4", Icon = "clock" }),
    raid = Window:AddTab({ Title = "ESP", Icon = "git-fork" }),
    De = Window:AddTab({ Title = "Fruit", Icon = "apple" }),    
    Ms = Window:AddTab({ Title = "Miss", Icon = "wifi" }),   
    Settings = Window:AddTab({ Title = "Setting", Icon = "setting" }),
}
...
Tabs.Main:AddButton({
        Title = "Nhập hết code lỏ",
        Description = "Code lồn ",
        Callback = function()            
function RedeemCode(value)
    ...
    Tabs.Main:AddParagraph({
        ...
        Content = "Tóm lại là kaitun như con cặc nên ae đừng dùng nhé hehe "
    })
...
local args = {[1] = "CyborgTrainer", [2] = "Buy"}
    ...
    Tabs.Sh:AddButton({
        Title = "Đổi tộc",
        Description = "có human sky gì đấy nhe",
        Callback = function()            
...
spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto bật haki", Default = true })
...
local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto bật ken", Default = false })
...
local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Đánh nhanh", Default = true })
...
spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Xóa thông báo", Default = false })
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Xóa chữ", Default = false })
...
task.spawn(function()
    ...
    local Toggle = Tabs.Settings:AddToggle("MyToggle", {Title = "Auto bật v4", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Farm lever", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Quái gần", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Làm nv qua sea 2", Default = false })
...
local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Làm nv qua sea 3", Default = false })
...
Toggle:OnChanged(function(Value)
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Kata", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Farm Nhà máy", Default = false })
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Dừng khi có key & cup", Default = false})
...
spawn(function()
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Farm Rương an toàn", Default = false})
...
local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Farm Rương ", Default = false })
...
if _G.ChestBypass then
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Đánh rip_indra", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Đánh Kata v2", Default = false })
 ...
 local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Auto Đánh râu đen", Default = false })
 ...
 spawn(function()
    ...
    local Toggle = Tabs.Qs:AddToggle("MyToggle", {Title = "Đánh boss lưỡi hái", Default = false })
    ...
    local CoNguoiDoiGietTao = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Nguyên liệu ", Default = false })
...
local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Farm Ectoplasm", Default = false })
    ...
    local Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Auto Đánh Boss", Default = false })
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Auto Random Trái", Default = false })
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Auto Cất trái", Default = false })
  ...
  pcall(function()
   ...
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PurchaseRawFruit",_G.SelectFruit)
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Nhặt trái", Default = false })
   ...
   local Toggle = Tabs.raid:AddToggle("MyToggle", {Title = "Mua chip đặt biệt", Default = false })
    Toggle:OnChanged(function(Value)
...
spawn(function()
    ...
    Tabs.RC:AddButton({
        Title = "Dịch chuyển đến Cây đại thụ",
        Description = "",
        Callback = function()            
...
local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Auto Hoàn thành trial Và Mua gear", Default = false })
...
Tabs.RC:AddButton({
        Title = "Dịch chuyển đến cửa tộc của bn",
        Description = "",
        Callback = function()            
        for i = 1, 8 do
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(28286.35546875, 14895.3017578125, 102.62469482421875))
...
Tabs.RC:AddParagraph({
        Title = "Up tộc",
        Content = "Up tộc đi mấy ní"
    })

local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Auto up v4", Default = false })
...
local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Kill người chs┊No Skill", Default = false })
...
local Toggle = Tabs.RC:AddToggle("MyToggle", {Title = "Spam để up v4┊Spam Skill", Default = false })
...
if World3 then
      local RoughSea = Tabs.Se:AddSection("Chỗ đảo Kitsune")
...
function UpdateKitsune()
    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Đảo Kitsune') then
        ...
        StatusKitsune:SetDesc("Kitsune Island : Có con cặc")
     end
end
spawn(function()
    pcall(function()
      ...
      local ToggleEspKitsune = Tabs.Se:AddToggle("ToggleEspKitsune", {Title = "Khoảng cách đảo",Description = "", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Se:AddToggle("ToggleTPKitsune", {Title = "Bay đến đảo Kitsune",Description = "", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Se:AddToggle("ToggleCollectAzure", {Title = "Nhặt linh hồn",Description = "", Default = false })
...
warnsea = Tabs.Se:AddParagraph({
    Title = "Thông báo !",
    Content = "Chúng tui chx làm đc sự kiện biển nên các bạn thông cảm nhé :c "
})

    Tabs.stack:AddSection("Lấy vật phẩm")
    
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Lấy kiếm Saber", Default = false })
    ...
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Kiếm florentino", Default = false})
...
local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Kiếm florentino HOP", Default = false})
...
local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Mua kiếm zoro", Default = false})
...
local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto lấy Yama", Default = false })
    ...
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto lấy Tushita", Default = false })
...
spawn(function()
    ...
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Lấy song kiếm", Default = false })
    ...
    local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Lấy đàn", Default = false })
...
local Toggle = Tabs.stack:AddToggle("MyToggle", {Title = "Auto Holy Torch", Default = false })
    ...
    Toggle:OnChanged(function(stati)
      ...
      Tabs.spl:AddSection("Bản nâng chỉ số")
...
local ToggleMelee = Tabs.spl:AddToggle("ToggleMelee", {Title = "Nâng chỉ số võ",Description = "", Default = false })
...
local ToggleDe = Tabs.spl:AddToggle("ToggleDe", {Title = "Nâng chỉ số máu",Description = "", Default = false })
...
local ToggleSword = Tabs.spl:AddToggle("ToggleSword", {Title = "Nâng chỉ số kiếm",Description = "", Default = false })
...
local ToggleGun = Tabs.spl:AddToggle("ToggleGun", {Title = "Nâng chỉ số súng", Description = "",Default = false })
...
local ToggleFruit = Tabs.spl:AddToggle("ToggleFruit", {Title = "Nâng chỉ số trái ác quỷ",Description = "", Default = false })
...
spawn(function()
    while wait() do
        ...
        local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Bay đến đảo bí ẩn", Default = false })
...
local Toggle = Tabs.Se:AddToggle("MyToggle", {Title = "Bay đến gear", Default = false })
...
NotificationLibrary:SendNotification("loading thành công", "chúc bn có 1 trải nghiệm thật tốt<3", 10)