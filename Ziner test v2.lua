...
--Key
wait(0.1)
AlchemyNotify("Thanks for using Ziner Hub!",5)
wait(0.1)
AlchemyNotify("discord.gg/dUdzZskBCC",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>ZINER Hub V2Script<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Yellow>Create By KAI WIBU<Color=/>"):Display()
wait(1)
repeat
    wait()
...
local HomePage = a:Tab("Home", "rbxassetid://")
