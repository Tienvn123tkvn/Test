...
spawn(function() 
    ...
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Cày Thuê Ở Discord<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Dev: Ziner-hub<Color=/>"):Display()
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Ziner-hub", HidePremium = false, IntroText = "Ziner-hub", SaveConfig = true, ConfigFolder = "Ziner-hub"})
