...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO PLAYER <Color=/>"):Display()
...
ImageButton.Image = "rbxassetid://http://www.roblox.com/asset/?id=17382863073"
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Ziner-hub on top",Description = "", Default = false })
