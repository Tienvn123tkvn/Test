...
do 
    ...
    local CreditTab = Window.createTab("ziner V2 [Free]", true)

    CreditTab.createTabHeader("ziner")
    ...
    local DD = CreditTab.createDropdown("ziner Nigga", icon, false, s, 1, function(a)
        print(a)
    end)
    ...
    local LB = CreditTab.createLabel("ziner Lug1a", icon)

    CreditTab.createButton("ziner Negar", icon, function()
    ...
    local ADLB = ADT.createLabel("ziner UWU", icon)
